...
sudo cp rockchip-kernel.sh my-add.txt make-dot-config.sh vp9-profile2-kernel-rkvdec.patch rkvdec-vdpu381-vp9.[ch] vp9-vdpu381-adapted.patch dvab-sarma-vp9-vdpu381.patch linux-beryllium-rkvdec.c ./base_camp
