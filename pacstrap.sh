...
yes | sudo pacman -U --root ./mnt /linux-aarch64-rockchip-7.2.6-1-aarch64.pkg.tar.*
yes | sudo pacman -U --root ./mnt /linux-aarch64-rockchip-headers-7.2.6-1-aarch64.pkg.tar.*
